...
export const FacultyProfilesSearchLayout = ({ config, appName }) => {
      ...
      <Grid>
        ...
        <Grid.Row className="mobile tablet only">
          ...
          <Grid.Column mobile={14} tablet={15} floated="right" className="mt-10">
            <SearchBar placeholder={i18next.t("Search Researcher Profiles...")} />
          </Grid.Column>
        </Grid.Row>
...
FacultyProfilesSearchLayout.propTypes = {
  config: PropTypes.object.isRequired,
  appName: PropTypes.string,
};

FacultyProfilesSearchLayout.defaultProps = {
  appName: "",
};
